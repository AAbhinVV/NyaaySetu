...
export default function DocumentVaultPage() {
    ...
    const cases = trpc.client.getMyCases.useQuery({ page: 1, limit: 50 })
        ...
        <div className="max-w-[960px]">
            ...
            <div className="flex max-md:flex-col justify-between items-start gap-4 mb-6">
                <div>
                    ...
                    <p className="font-body text-sm text-muted-foreground mt-1">End-to-end secured • Blockchain verified</p>
                </div>
            ...
            {docs.isLoading ? (
                ...
                <div className="text-center py-16 px-8 bg-card rounded-xl shadow-lawyer">
                    ...
                    <p className="font-body text-base font-semibold text-foreground">No documents found</p>
